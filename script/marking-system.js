...
(function ($, window, document, undefined) {
  var Marking = function (ele, opt) {
    this.$element = ele,
      this.defaults = {
        ...
        'width': 20,
        'spaceBetween': 2,
        'backgroundImageInitial': '../image/celebrity/star_hollow.png', //图标初始样式
        'backgroundImageOver': '../image/celebrity/star_solid.png', //点击后图标
        'num': 5, //图标数量
  ...
  Marking.prototype = {
    ...
    clickChangeAll: function () {
      var that = this.$element;
      var This = this;
      window.grade = this.options.grade;
      var flag = true;
      that.find('.set_image_item').click(function (e) {
        if (This.options.grade == 0 && flag) {
          flag = false;
          grade = $(this).index() + 1
